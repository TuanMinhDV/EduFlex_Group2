                                ...
                                <div class="widget-inner">
                                    <form action="profile" id="profileForm" method="post" class="edit-profile m-b30">
                                        <div class="">
                                            ...
                                            <!--<input class="form-control hide" name="id" type="text" value="${sessionScope.account.account_id}">-->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <button type="" class="btn-secondry" style="margin-top: 70px">Change profile picture</button>
                                            </div>
                                        </div>
                                        <div class="form-group row">
