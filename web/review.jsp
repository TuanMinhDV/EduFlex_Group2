                            ...
                            <div class="invoice-wrapper">
                                ...
                                <div class="line-items">
                                    ...
                                    <c:forEach var="item" items="${cart.items}">
                                        <input type="hidden" name="course_name" value="${item.orderCourse.course_name}">
                                        <div class="items">
                                            <div class="row item">
                                                <div class="col-xs-7 desc">
                                                    ${item.orderCourse.course_name}
                                                </div>
                                                <div class="col-xs-5 amount text-right">
                                                    ${item.orderCourse.price*(1-item.orderCourse.discount/100)} USD
                                                </div>
                                            </div>
                                        </div>
                                    </c:forEach>
