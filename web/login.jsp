        ...
        <div class="page-wraper">
            ...
            <div class="account-form">
                <div class="account-head" style="background-image:url(EduChamp-Template/assets/images/background/bg2.jpg);">
                    <a href="home"><img src="EduChamp-Template/assets/images/logo-white-2.png" alt=""></a>
                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input name="user" id="username" type="text" required="" class="form-control" value="${cookie.cuser.value}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group"> 
                                            <input value="${cookie.cpass.value}" name="pass" type="password" class="form-control" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
